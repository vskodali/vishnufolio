  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/1jx9kbTuuKZ-V6W_hqcAeF2fhUMW_Ac5M/view"
            target="_blank"
        ...
        <div className="flex gap-10 text-[#e4ded7] sm:gap-12 md:gap-14 lg:gap-14">
          <Link
            href="https://github.com/vskodali"
            target="_blank"
          ...
          <Link
            href="https://www.linkedin.com/in/vishnusaikodali"
            target="_blank"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Fullstack Engineer and Java Developer, prev at{" "}
            <Link
            ...
            and{" "}
            <Link
              href="https://www.linkedin.com/company/mindtreeltd"
              target="_blank"
              className="underline underline-offset-2 hover:no-underline"
              aria-label="Walgreens Website"
            >
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Focused on creating solution in scale, working remotely from San
